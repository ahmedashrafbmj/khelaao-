...
export default function NeedPlayerForTeam(){
    const FormDetails = [
        ...
        {label:"Wanted Role", type:"text",placeholder:"Wanted Role", name:"WantedRole"},
    ]
    // const data1 = {City:"karachi"}
    const [data,setData] = useState({Contact:"",City:"",Comment:"",WantedRole:""})
    const addFeedback = async (newFeedback) => {
        console.log(newFeedback)
        {console.log(":wdiuu")}

        const response = await fetch("http://localhost:5000/api/NeedPlayerForTeam/postNeedPlayerForTeam", {
          method: "POST",
          headers: {
